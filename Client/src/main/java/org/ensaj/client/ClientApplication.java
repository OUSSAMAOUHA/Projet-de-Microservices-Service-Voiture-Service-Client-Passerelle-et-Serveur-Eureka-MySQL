...
public class ClientApplication {
    ...
    CommandLineRunner initialiserMYSQL(ClientRepository clientRepository){
        return args -> {
            clientRepository.save(new Client(Long.parseLong("1"), "OUHAYOU OUSSAMA", Float.parseFloat("22")));
            clientRepository.save(new Client(Long.parseLong("2"), "SALMI ALI", Float.parseFloat("40")));
        };
    }
}
